...
!function (t, e, n, o) {
    ...
    if (t.console = t.console || {
        ...
        n.extend(b.prototype, {
            init: function () {
                ...
                var a = this, i = a.current, s = null, r = !1;
                ...
                var o = this, a = e.createElement("img"), i = n(a);
                ...
                var e = this, n = t || e.current, o = n.opts.caption, a = e.$refs.caption, i = !1;
                ...
                var t = this, o = t.current, a = o.index, i = t.$refs.container, s = t.$refs.caption,
                    r = o.opts.caption;
    ...
    d.prototype.destroy = function () {
        ...
        var o = this, a = !1, i = o.instance.group.length, s = Math.abs(o.distanceX),
            r = "x" == t && i > 1 && (o.dMs > 130 && s > 10 || s > 50), c = 300;
        ...
        n.fancybox.defaults.hash !== !1 && (n(e).on({
            "onInit.fb": function (t, e) {
                ...
                a && a.opts.hash !== !1 && (r = i(o), r && (o.currentHash = r + (o.group.length > 1 ? "-" + (a.index + 1) : ""), t.location.hash !== "#" + o.currentHash && (s && !o.origHash && (o.origHash = t.location.hash), o.hashTimer && clearTimeout(o.hashTimer), o.hashTimer = setTimeout(function () {
                    ...
                    // console.log('https://motos.honda.com.co' + t.location.pathname);
                    "replaceState" in t.history ? (t.history[s ? "pushState" : "replaceState"]({},
                        e.title, 'https://motos.honda.com.co' + t.location.pathname + t.location.search + "#" + o.currentHash), s && (o.hasCreatedHistory = !0)) : t.location.hash = o.currentHash, o.hashTimer = null
                }, 300))))
