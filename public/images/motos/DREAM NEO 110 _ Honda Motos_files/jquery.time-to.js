(function (factory) {
    ...
    var defaults = {
        ...
        width: 105,               // width of a digit area
        height: 105,              // height of a digit area
    ...
    $.fn.timeTo = function () {
        ...
        return this.each(function () {
            ...
            if (!data.vals) {
                ...
                style = data.fontSize
                    ? ' style="width:32px; height:' + data.height + 'px;"'
                    : ' style=""';
                ...
                thtml = (data.displayCaptions
                    ? (data.displayHours
                            ? '<figure>$1<figcaption>'
                                + language.hours + '</figcaption></figure>'
                            : '')
                        + '<figure>$1<figcaption>' + language.min
                        + '</figcaption></figure>'
                        + '<figure>$1<figcaption>' + language.sec
                        + '</figcaption></figure>'
                    : (data.displayHours ? '$1' : '') + '$1' + '$1'
                ...
                if (data.displayDays > 0) {
                    ...
                    for (i = data.displayDays - 1; i > 0; i -= 1) {
                        dhtml += i === 1
                            ? dhtml2.replace('">', '' + Math.round(marginRight) + 'px">')
                            : dhtml2;
                    }
                    thtml = (data.displayCaptions
                        ? '<figure>$1'
